...
app.use(cors({
    origin: ['https://cdfinance.pl', 'http://cdfinance.pl', 'http://localhost:3000', 'https://127.0.0.1:3000'],
    credentials: true
}))
...
//   res.header('Access-Control-Allow-Headers', 'Content-Type, Authorization, language, Cookie');
